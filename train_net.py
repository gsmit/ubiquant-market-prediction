...
from utils.models import BasicMLP, AdaptiveMLP
...
if __name__ == '__main__':
    ...
    for version in ['c01', 'c02', 'c03', 'c04', 'c05']:
        ...
        for fold in folds:
            ...
            print('Min/max targets:', np.min(y_train), np.max(y_train))
            ...
            net = BasicMLP(
                in_dim=in_dim, hidden_dim=hidden_dim, dropout=dropout,
                activation=nn.ReLU(),
            )

            # # Initialize both encoder and decoder networks
            # net = AdaptiveMLP(
            #     in_dim=in_dim, hidden_dim=hidden_dim, emb_dim=emb_dim,
            #     dropout=dropout, activation=nn.ReLU(),
            # )
