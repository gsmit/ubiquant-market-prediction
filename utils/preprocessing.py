...
class RankGaussScaler(BaseEstimator, TransformerMixin):
    ...
    Original implementation: https://github.com/aldente0630/gauss-rank-scaler.
    ...
    def fit(self, X, y=None):
        ...
        """
        X = check_array(
            X, copy=self.copy, estimator=self, dtype=np.float32, force_all_finite=True
        )
    ...
    def transform(self, X, copy=None):
        ...
        X = check_array(
            X, copy=copy, estimator=self, dtype=np.float32, force_all_finite=True
        )
